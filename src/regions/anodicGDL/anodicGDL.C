...
void Foam::regionTypes::anodicGDL::updateSourceTerms()
{
    ...
    sT_ = sigma_()*(fvc::grad(phiE_())&fvc::grad(phiE_()));
}

void Foam::regionTypes::anodicGDL::updateCurrentDensity()
{
...
void Foam::regionTypes::anodicGDL::meshMotionCorrector()
{
    // do nothing, add as required
}

Foam::scalar Foam::regionTypes::anodicGDL::getMinDeltaT()
{
     return GREAT;
}
