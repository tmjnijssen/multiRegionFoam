...
monolithicCouplingFvPatchField<Type>::originalPatchField() const
{
...
template<class Type>
monolithicCouplingFvPatchField<Type>::monolithicCouplingFvPatchField
(
    const fvPatch& p,
...
monolithicCouplingFvPatchField<Type>::monolithicCouplingFvPatchField
(
    const monolithicCouplingFvPatchField<Type>& ptf,
    const fvPatch& p,
    const DimensionedField<Type, volMesh>& iF,
...
monolithicCouplingFvPatchField<Type>::lookupShadowPatchField
(
    const word& name,
    const LookupField*,
    const LookupType*
...
)
{
    if(debug)
    {
        Info << "In monolithicCouplingFvPatchField<Type>::initEvaluate() on "
...
template<class Type>
void monolithicCouplingFvPatchField<Type>::evaluate
(
...
template<class Type>
void monolithicCouplingFvPatchField<Type>::updateCoeffs()
{
    if(debug)
    {
        Info << "In monolithicCouplingFvPatchField<Type>::updateCoeffs() on "
            << this->dimensionedInternalField().name()
            << " in " << this->patch().boundaryMesh().mesh().name()
            << " " << this->updated() << endl;
    }
...
template<class Type>
tmp<Field<Type> > monolithicCouplingFvPatchField<Type>::snGrad() const
{
...
template<class Type>
void monolithicCouplingFvPatchField<Type>::initInterfaceMatrixUpdate
(
...
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "monolithicCouplingFvPatchField<Type>::initInterfaceMatrixUpdate"
...
template<class Type>
void monolithicCouplingFvPatchField<Type>::updateInterfaceMatrix
(
    const scalarField& psiInternal,
    scalarField& result,
    const lduMatrix&,
...
) const
{
    ...
    else
    {
        FatalErrorIn
        (
            "monolithicCouplingFvPatchField<Type>::updateInterfaceMatrix"
